					<div class="row">
						<div class="col-md-3">
							<a href="javascript:popup()"><button class="btn btn-xs btn-danger">Select</button></a> <label for="login-form-username"> TYPE: TEXT:</label>
						...
						<div class="col-md-3">
							<a href="javascript:popup()"><button class="btn btn-xs btn-danger">Select</button></a> <label for="login-form-username"> TYPE: COLOR:</label>
						...
						<div class="col-md-3">
							<a href="javascript:popup()"><button class="btn btn-xs btn-danger">Select</button></a> <label for="login-form-username"> TYPE: PHONE:</label>
							<div class="input-group">
						...
						<div class="col-md-3">
							<a href="javascript:popup()"><button class="btn btn-xs btn-danger">Select</button></a> <label for="login-form-username"> TYPE: NUMBER:</label>
							<div class="input-group">
						...
						<div class="col-md-3">
							<a href="javascript:popup()"><button class="btn btn-xs btn-danger">Select</button></a> <label for="login-form-username"> TYPE: EMAIL:</label>
							<div class="input-group">
						...
						<div class="col-md-3">
							<a href="javascript:popup()"><button class="btn btn-xs btn-danger">Select</button></a> <label for="login-form-username"> TYPE: CURRENCY:</label>
							<div class="input-group">
						...
						<div class="col-md-3">
							<a href="javascript:popup()"><button class="btn btn-xs btn-danger">Select</button></a> <label for="login-form-username"> TYPE: URL:</label>
							<div class="input-group">
						...
						<div class="col-md-3">
							<a href="javascript:popup()"><button class="btn btn-xs btn-danger">Select</button></a> <label for="login-form-username"> TYPE: SEARCH:</label>
							<div class="input-group">
						...
						<div class="col-md-3">
							<a href="javascript:popup()"><button class="btn btn-xs btn-danger">Select</button></a> <label for="login-form-username"> TYPE: USERNAME:</label>
							<div class="input-group">
						...
						<div class="col-md-3">
							<a href="javascript:popup()"><button class="btn btn-xs btn-danger">Select</button></a> <label for="login-form-username"> TYPE: PASSWORD:</label>
							<div class="input-group">
						...
						<div class="col-md-3" style="">
							<a href="javascript:popup()"><button class="btn btn-xs btn-danger">Select</button></a> <label for="login-form-username"> TYPE: TIME:</label>
							<div class="input-group">
						...
						<div class="col-md-3" style="">
							<a href="javascript:popup()"><button class="btn btn-xs btn-danger">Select</button></a> <label for="login-form-username"> TYPE: DATE:</label>
							<div class="input-group">
						...
						<div class="col-md-3" style="">
							<a href="javascript:popup()"><button class="btn btn-xs btn-danger">Select</button></a> <label for="login-form-username"> TYPE: WEEK:</label>
							<div class="input-group">
						...
						<div class="col-md-3" style="">
							<a href="javascript:popup()"><button class="btn btn-xs btn-danger">Select</button></a> <label for="login-form-username"> TYPE: MONTH:</label>
							<div class="input-group">
						...
						<div class="col-md-3">
							<a href="javascript:popup()"><button class="btn btn-xs btn-danger">Select</button></a> <label for="login-form-username"> TYPE: REMOTE CONTENT [AJAX]</label>
						...
						<div class="col-md-3">
							<a href="javascript:popup()"><button class="btn btn-xs btn-danger">Select</button></a> <label for="login-form-username"> TYPE: CODE</label>
						...
						<div class="row">
						<div class="col-md-3">
							<a href="javascript:popup()"><button class="btn btn-xs btn-danger">Select</button></a> <label for="login-form-username"> TYPE: PHOTO UPLOADER:</label>
						...
						<div class="col-md-3" style="">
							<a href="javascript:popup()"><button class="btn btn-xs btn-danger">Select</button></a> <label for="login-form-username"> TYPE: SELECT</label>
							<div class="input-group">
								<select style="width:260px" data-live-search="true" onchange="saveSite(this.value)" id="ss" class="select-1 form-control select2-hidden-accessible" multiple="" style="width:350px" tabindex="-1" aria-hidden="true">
						...
						<div class="col-md-3" style="">
							<a href="javascript:popup()"><button class="btn btn-xs btn-danger">Select</button></a> <label for="login-form-username"> TYPE: CHECKBOX</label>
							<div class="input-group">
								<div>
						...
						<div class="col-md-3" style="">
							<a href="javascript:popup()"><button class="btn btn-xs btn-danger">Select</button></a> <label for="login-form-username"> TYPE: RADIO</label>
